...
SOURCE_FILES := main game/game game/create/create game/create/game_state game/create/nes_text game/create/scores game/create/session_duck game/create/sounds game/create/sprite game/create/sprites game/create/textures game/create/window game/set_current/round game/set_current/score game/update/do game/change_music game/center_text_box_text game/get_duck_speed random top_score text_utils
...
obj/%.o: src/%.c libmy
	...
	mkdir --parents obj/game/set_current
