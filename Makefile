...
SOURCE_FILES := main game/game game/create/create game/create/game_state game/create/nes_text game/create/scores game/create/session_duck game/create/sounds game/create/sprite game/create/sprites game/create/textures game/create/window game/handle/key game/session_duck/set game/session_duck/update/update game/session_duck/update/falling game/session_duck/update/flying game/set/current/round game/set/current/score game/set/mode/mode game/set/mode/exit game/set/mode/init/init game/set/mode/init/end_round game/set/mode/init/session game/set/mode/init/start_round game/set/mode/init/title game/update/do game/change_music game/center_text_box_text game/dog game/get_duck_speed random top_score text_utils
